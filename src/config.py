...
DUPLICATE_ROWS_FRACTION = 0.10
SIGN_FLIP_ROWS_FRACTION = 0.067
SIGN_FLIP_MIN_COLS = 1
SIGN_FLIP_MAX_COLS = 4

DECIMAL_SHIFT_ROWS_FRACTION = 0.053
DECIMAL_SHIFT_MIN_COLS = 1
DECIMAL_SHIFT_MAX_COLS = 3
DECIMAL_SHIFT_MULTIPLIER = 10

MISSING_VALUE_ROWS_FRACTION = 0.08
MISSING_VALUE_MIN_COLS = 1
MISSING_VALUE_MAX_COLS = 3

ZERO_CORRUPTION_ROWS_FRACTION = 0.033
ZERO_CORRUPTION_MIN_COLS = 1
ZERO_CORRUPTION_MAX_COLS = 2

IQR_BOUNDARY_ROWS_FRACTION = 0.133
IQR_BOUNDARY_MIN_SIGMA = 2.0
IQR_BOUNDARY_MAX_SIGMA = 2.8
