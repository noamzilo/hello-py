...
NUM_ROWS = 150
NUM_COLS = 5
CLEAN_DATA_FRACTION = 0.33

CLEAN_DATA_MEAN = 50
CLEAN_DATA_STD = 10

NOISE_UNIFORM_RANGE = 12
NOISE_NORMAL_STD = 7
NOISE_MULTIPLICATIVE_RANGE = 0.20
NOISE_EXPONENTIAL_SCALE = 4
NOISE_LAPLACE_SCALE = 5

MODERATE_OUTLIER_FRACTION = 0.25
MODERATE_OUTLIER_MIN_SIGMA = 1.5
MODERATE_OUTLIER_MAX_SIGMA = 2.5
OUTLIER_NEGATION_FREQUENCY = 3

DUPLICATE_ROWS_FRACTION = 0.13
SIGN_FLIP_ROWS_FRACTION = 0.09
SIGN_FLIP_MIN_COLS = 1
SIGN_FLIP_MAX_COLS = 4

DECIMAL_SHIFT_ROWS_FRACTION = 0.07
DECIMAL_SHIFT_MIN_COLS = 1
DECIMAL_SHIFT_MAX_COLS = 3
DECIMAL_SHIFT_MULTIPLIER = 10

MISSING_VALUE_ROWS_FRACTION = 0.10
MISSING_VALUE_MIN_COLS = 1
MISSING_VALUE_MAX_COLS = 3

ZERO_CORRUPTION_ROWS_FRACTION = 0.05
ZERO_CORRUPTION_MIN_COLS = 1
ZERO_CORRUPTION_MAX_COLS = 3

IQR_BOUNDARY_ROWS_FRACTION = 0.20
IQR_BOUNDARY_MIN_SIGMA = 2.1
IQR_BOUNDARY_MAX_SIGMA = 2.9
